  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white p-6 rounded-lg shadow-lg text-center text-gray-700 w-11/12 max-w-md">
        ...
        {/* Winner Section */}
        <div className="mb-4 mx-3 border border-gray-300 bg-gray-50 p-3 rounded-lg shadow-sm">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4 pl-2">
              <Image
                ...
                height={64}
                width={64}
                className="w-8 h-8 md:h-10 md:w-10 rounded-full border border-gray-400"
              />
              <div>
                <p className="text-sm md:text-md font-bold text-left text-gray-800">{winner.name}</p>
                <p className="text-xs md:text-sm text-gray-600 text-left">Score: {winner.score}</p>
              </div>
            </div>
            <span className="text-2xl font-bold text-gray-700 pr-2">#1</span>
          </div>
        </div>

        {/* Loser Section */}
        <div className="mx-3 border border-gray-200 p-3 rounded-lg shadow-sm">
          <div className="flex items-center justify-between">
            {/* Loser Avatar */}
            <div className="flex items-center gap-4 pl-2">
              <Image
              ...
              />
              <div>
                <p className="text-sm md:text-md font-bold text-gray-800">{loser.name}</p>
                <p className="text-xs md:text-sm text-gray-600 text-left">Score: {loser.score}</p>
              </div>
            </div>
            <span className="text-2xl font-bold text-gray-400 pr-2">#2</span>
          </div>
        </div>
