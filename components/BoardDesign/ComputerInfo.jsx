...
const PlayerInfo = ({ player1, player2, symbol, turn, isHost }) => {
  ...
  // Swapped: current player info reflects the opponent's logic and vice versa
  const opponentName = isHost ? player1 : player2;
  const opponentSymbol = isHost ? player1Symbol : player2Symbol;
  const opponentImage = isHost ? "/images/profileImage.jpg" : "/images/computerImage.jpg";

  const currentPlayerName = isHost ? player2 : player1;
  const currentPlayerSymbol = isHost ? player2Symbol : player1Symbol;
  const currentPlayerImage = isHost ? "/images/computerImage.jpg" : "/images/profileImage.jpg";
